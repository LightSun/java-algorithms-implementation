...
public class BreadthFirstTraversalTest {
    ...
    public void test2() {
        ...
        assertTrue(result[1].getValue()==0);
        assertTrue(result[2].getValue()==3);
        assertTrue(result[3].getValue()==1);
    }

    @Test
    public void test3() {
        final Graph.Vertex<Integer>[] result = BreadthFirstTraversal.breadthFirstTraversal(graph, v0);
        assertTrue(result[0].getValue()==0);
        assertTrue(result[1].getValue()==1);
        assertTrue(result[2].getValue()==2);
        assertTrue(result[3].getValue()==3);
    }
}
