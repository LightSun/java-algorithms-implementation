...
public class Sorts {
    ...
    public void testInsertionSorts() {
        ...
        AllTests.assertTrue("Inerstion sort unsorted error. result="+print(result), check(result));
        result = InsertionSort.sort(sorted.clone());
        AllTests.assertTrue("Inerstion sort sorted error. result="+print(result), check(result));
        result = InsertionSort.sort(reverse.clone());
        AllTests.assertTrue("Inerstion sort reverse error. result="+print(result), check(result));
    }
    ...
    public void testBubbleSorts() {
        ...
        AllTests.assertTrue("Bubble sort unsorted error. result="+print(result), check(result));
        result = BubbleSort.sort(sorted.clone());
        AllTests.assertTrue("Bubble sort sorted error. result="+print(result), check(result));
        result = BubbleSort.sort(reverse.clone());
        AllTests.assertTrue("Bubble sort reverse error. result="+print(result), check(result));
    }
    ...
    public void testShellsSorts() {
        ...
        AllTests.assertTrue("Shell's sort unsorted error. result="+print(result), check(result));
        result = ShellSort.sort(shells, sorted.clone());
        AllTests.assertTrue("Shell's sort sorted error. result="+print(result), check(result));
        result = ShellSort.sort(shells, reverse.clone());
        AllTests.assertTrue("Shell's sort reverse error. result="+print(result), check(result));
    }
    ...
    public void testMergeSortsInPlace() {
        ...
        AllTests.assertTrue("Merge sort unsorted error. result="+print(result), check(result));
        result = MergeSort.sort(MergeSort.SPACE_TYPE.IN_PLACE, sorted.clone());
        AllTests.assertTrue("Merge sort sorted error. result="+print(result), check(result));
        result = MergeSort.sort(MergeSort.SPACE_TYPE.IN_PLACE, reverse.clone());
        AllTests.assertTrue("merge sort reverse error. result="+print(result), check(result));
    }
    ...
    public void testQuickSorts() {
        ...
        AllTests.assertTrue("Quick sort pivot firt unsorted error. result="+print(result), check(result));
        result = QuickSort.sort(QuickSort.PIVOT_TYPE.FIRST, sorted.clone());
        AllTests.assertTrue("Quick sort pivot firt sorted error. result="+print(result), check(result));
        result = QuickSort.sort(QuickSort.PIVOT_TYPE.FIRST, reverse.clone());
        AllTests.assertTrue("Quick sort pivot firt reverse error. result="+print(result), check(result));
        result = QuickSort.sort(QuickSort.PIVOT_TYPE.MIDDLE, unsorted.clone());
        AllTests.assertTrue("Quick sort pivot middle unsorted error. result="+print(result), check(result));
        result = QuickSort.sort(QuickSort.PIVOT_TYPE.MIDDLE, sorted.clone());
        AllTests.assertTrue("Quick sort pivot middle sorted error. result="+print(result), check(result));
        result = QuickSort.sort(QuickSort.PIVOT_TYPE.MIDDLE, reverse.clone());
        AllTests.assertTrue("Quick sort pivot middle reverse error. result="+print(result), check(result));
        result = QuickSort.sort(QuickSort.PIVOT_TYPE.RANDOM, unsorted.clone());
        AllTests.assertTrue("Quick sort pivot random unsorted error. result="+print(result), check(result));
        result = QuickSort.sort(QuickSort.PIVOT_TYPE.RANDOM, sorted.clone());
        AllTests.assertTrue("Quick sort pivot random sorted error. result="+print(result), check(result));
        result = QuickSort.sort(QuickSort.PIVOT_TYPE.RANDOM, reverse.clone());
        AllTests.assertTrue("Quick sort pivot random reverse error. result="+print(result), check(result));
    }
    ...
    public void testHeapSorts() {
        ...
        AllTests.assertTrue("Heap sort unsorted error. result="+print(result), check(result));
        result = HeapSort.sort(sorted.clone());
        AllTests.assertTrue("Heap sort sorted error. result="+print(result), check(result));
        result = HeapSort.sort(reverse.clone());
        AllTests.assertTrue("Heap sort reverse error. result="+print(result), check(result));
    }
    ...
    public void testCountingSorts() {
        ...
        AllTests.assertTrue("Counting sort unsorted error. result="+print(result), check(result));
        result = CountingSort.sort(sorted.clone());
        AllTests.assertTrue("Counting sort sorted error. result="+print(result), check(result));
        result = CountingSort.sort(reverse.clone());
        AllTests.assertTrue("Counting sort reverse error. result="+print(result), check(result));
    }
    ...
    public void testRadixSorts() {
        ...
        AllTests.assertTrue("Radix sort unsorted error. result="+print(result), check(result));
        result = RadixSort.sort(sorted.clone());
        AllTests.assertTrue("Radix sort sorted error. result="+print(result), check(result));
        result = RadixSort.sort(reverse.clone());
        AllTests.assertTrue("Radix sort reverse error. result="+print(result), check(result));
    }
    ...
    public void testAmericanFlagSorts() {
        ...
        AllTests.assertTrue("American flag sort unsorted error. result="+print(result), check(result));
        result = AmericanFlagSort.sort(sorted.clone());
        AllTests.assertTrue("American flag sort sorted error. result="+print(result), check(result));
        result = AmericanFlagSort.sort(reverse.clone());
        AllTests.assertTrue("American flag sort reverse error. result="+print(result), check(result));
    }
