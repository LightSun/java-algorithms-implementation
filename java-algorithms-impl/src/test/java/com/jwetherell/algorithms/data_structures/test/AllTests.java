...
public class AllTests {
    ...
    public static void assertTrue(String msg, boolean expre){
        Assertions.assertTrue(expre, msg);
    }
    public static void assertFalse(String msg, boolean expre){
        Assertions.assertFalse(expre, msg);
    }
}
