...
public class MatrixTests {
    ...
    public void testMatrix() {
        ...
        AllTests.assertTrue("Matrix multiplication error. matrix3="+matrix3+" result1"+result1, matrix3.equals(result1));
        ...
        AllTests.assertTrue("Matrix subtraction error. matrix5="+matrix5+" result2"+result2, matrix5.equals(result2));
        ...
        AllTests.assertTrue("Matrix addition error. matrix6="+matrix6+" result3"+result3, matrix6.equals(result3));
        ...
        AllTests.assertTrue("Matrix multiplication error. matrix9="+matrix9+" result4"+result4, matrix9.equals(result4));
    }
