...
public class ImplicitKeyTreapTests {
    ...
    public void implicitKeyInsertTests() {
        ...
        assertTrue(inOrder.equals("1 2 3 4 5 6 7 8 "));
    }
    ...
    public void implicitKeySplitMergeTests() {
        ...
        assertTrue(inOrder.equals("2 3 4 1 5 6 7 8 "));

        moveToBack(treap, 2, 5);
        inOrder = toString(Integer.class, treap.inOrder());
        // move '4 1 5' to the back
        assertTrue(inOrder.equals("2 3 6 7 8 4 1 5 "));

        moveToFront(treap, 3, 7);
        inOrder = toString(Integer.class, treap.inOrder());
        // move '7 8 4 1' to the front
        assertTrue(inOrder.equals("7 8 4 1 2 3 6 5 "));

        moveToBack(treap, 0, 4);
        inOrder = toString(Integer.class, treap.inOrder());
        // move '2 3 6 5' to back
        assertTrue(inOrder.equals("2 3 6 5 7 8 4 1 "));
    }
    ...
    public void implicitKeyTests() {
        ...
        treap.add(0, 9);
        inOrder = toString(Integer.class, treap.inOrder());
        assertTrue(inOrder.equals("9 1 2 3 5 6 7 8 "));

        // insert value @ index 8 (tail)
        treap.add(8, 10);
        inOrder = toString(Integer.class, treap.inOrder());
        assertTrue(inOrder.equals("9 1 2 3 5 6 7 8 10 "));

        // insert via value (always inserts at end)
        treap.add((Integer)11);
        inOrder = toString(Integer.class, treap.inOrder());
        assertTrue(inOrder.equals("9 1 2 3 5 6 7 8 10 11 "));

        // remove via value
        treap.remove((Integer)5);
        inOrder = toString(Integer.class, treap.inOrder());
        assertTrue(inOrder.equals("9 1 2 3 6 7 8 10 11 "));

        moveToFront(treap, 5, 9);
        inOrder = toString(Integer.class, treap.inOrder());
        // move '7 8 10 11' to the front
        assertTrue(inOrder.equals("7 8 10 11 9 1 2 3 6 "));

        moveToBack(treap, 2, 6);
        inOrder = toString(Integer.class, treap.inOrder());
        // move '10 11 9 1' to back
        assertTrue(inOrder.equals("7 8 2 3 6 10 11 9 1 "));
    }
